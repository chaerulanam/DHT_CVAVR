...
_0x0:
	.DB  0x77,0x77,0x77,0x2E,0x61,0x6E,0x61,0x6B
	.DB  0x6B,0x65,0x6E,0x64,0x61,0x6C,0x69,0x2E
	.DB  0x63,0x6F,0x6D,0x0,0x74,0x65,0x6D,0x70
	.DB  0x65,0x72,0x61,0x74,0x75,0x72,0x65,0x3A
	.DB  0x20,0x0,0x43,0x0,0x68,0x75,0x6D,0x69
	.DB  0x64,0x69,0x74,0x79,0x3A,0x20,0x0,0x25
	.DB  0x20,0x52,0x48,0x0,0x65,0x72,0x72,0x6F
	.DB  0x72,0x0
_0x2080060:
	.DB  0x1
_0x2080000:
...
; 0000 0094 		if(dht_gettemperaturehumidity(&temperature, &humidity) != -1) {
	...
	LDI  R26,LOW(4)
	LDI  R27,HIGH(4)
	CALL _dht_gettemperaturehumidity
	MOV  R26,R30
	LDI  R30,LOW(255)
	LDI  R27,0
	SER  R31
...
; .FSTART _expanderWrite
	ST   -Y,R26
	CALL _wire_send_start
	ST   -Y,R7
	LDI  R26,LOW(0)
	CALL _wire_send_add_rw
	MOV  R30,R12
	LD   R26,Y
	OR   R30,R26
	MOV  R26,R30
	CALL _wire_send_byte
	CALL _wire_send_stop
	JMP  _0x2100001
; .FEND
_pulseEnable:
; .FSTART _pulseEnable
